...
import { LOGIN_PATH_CONTEXT, SIGNUP_PATH_CONTEXT, UserData, UserService } from '../../../app/services/data/user.service';
...
describe('LoginComponent', () => {
    ...
    it('should login user', () => {
        ...
        expect(userServiceMock.login).toHaveBeenCalledOnceWith(
            'user@gmail.com', '123Apple!'
        );
    ...
    it('should signup user', () => {
        ...
        expect(userServiceMock.signUp).toHaveBeenCalledOnceWith(
            'user@gmail.com', 'user', '123Apple!'
        );
        expect(component['loginError']()).toBe('');
        expect(dialogRefMock.close).toHaveBeenCalledOnceWith({
            email: 'user@gmail.com',
    ...
    it('should display Sign Up link on login window', () => {
        component['pathContext'].set(LOGIN_PATH_CONTEXT);
        fixture.detectChanges();
        expect(fixture.nativeElement.querySelector('#login-nav-link').textContent.trim())
            .toBe('Don\'t have an account? Sign up here.');
    });
    ...
    it('should display Login link on signup window', () => {
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement.querySelector('#login-nav-link').textContent.trim())
            .toBe('Already have an account? Login here.');
    });
    //#endregion
});
