defmodule MangaService.SeriesDB.Series do
  ...
  def changeset(series, attrs) do
    series
    |> cast(attrs, [:series_id, :title, :associated_titles, :url, :category, :series_match_confidence, :editions, :volumes, :description, :cover_image, :genres, :themes, :latest_chapter, :release_status, :status, :authors, :publishers, :bayesian_rating, :rank, :recommendations])
    |> validate_required([:series_id, :title, :associated_titles, :url, :category, :series_match_confidence, :editions, :volumes, :genres, :themes, :authors, :publishers, :recommendations])
